...
# f"https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=34.068126,-118.444082&radius=1000&type=school&key={api_key}"
## TODO:
...
# https://maps.googleapis.com/maps/api/place/findplacefromtext/json?input={qtype}&inputtype=textquery&fields=formatted_address,name&locationbias=circle:1000@{coords[0]},{coords[1]}&key={api_key}}
...
def get_place_info(placeName,lat,lon):
	# f"https://maps.googleapis.com/maps/api/place/nearbysearch/json?location={coords[0]},{coords[1]}&radius={radius}&type={qtype}&key={api_key}"
